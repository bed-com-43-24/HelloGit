...
int main(){
    ...
    *pPointer = 10;// assign a value to first element
    /*increment the pointer using pointer arithmetic  to assign the address of the second element of the pointer */
    pPointer++;
    ...
    *pPointer = 30;//assign a value to the third element
    ...
    /*assign the address  to the fourth element to the pointer using pointer Arithmetic */
